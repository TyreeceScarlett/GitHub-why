...
public class Dialogue {
	...
	[Help("Start by supplying Defaults below. Then, for each Conversation Element you can override the Defaults with a new value. Otherwise, leave blank to use Defaults.", UnityEditor.MessageType.Info)]
